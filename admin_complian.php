...
//$sql="delete from inquiry where inq_id='$a'";
	...
	$dyn_table = '<table border="1" cellpadding="10"><th colspan="2" style="background-color:Black; color:#FFFFFF;" >Contact detail</th>';
		...
		{	
			$dyn_table .= "<tr style='background:white;color:black;'><td style='color:black;'><b>".$row['com_id']."</b><br>".$row['uname']."</td><td><a style='color:green;' href='admin_contact_delete.php?cnct_id=$row[cnct_id]'>Delete</a>&nbsp;&nbsp;&nbsp;<a style='color:red;' href='admin_contact_update.php?cnct_id=$row[cnct_id]'>Update</a></td>";
