...
<div class="gallery clear">
	...
	<?php
		...
		while($res=mysql_fetch_array($rdata))
		{
			...
			echo "<br><a style='margin-left:20px;' href='admin_delete_banner.php?bid=$res[gal_id]&p=$res[price]'><b><u>Delete</u></b></a></font>";
			echo "<a style='margin-left:20px;' href='admin_update_banner.php?bid=$res[gal_id]&p=$res[price]'><b><u>Update</u></b></a></font></td></tr>";
