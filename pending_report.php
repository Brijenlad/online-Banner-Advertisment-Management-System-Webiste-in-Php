...
echo "<h1>Banner Pending Report </h1>";

$sql="select * from renew,banner,gallery where renew.ban_id=banner.ban_id and banner.gal_id=gallery.gal_id and renew.status='Pending'";
$result=mysql_query($sql);
$c=	$row=mysql_num_rows($result);
echo "<font Style='color:red;float:right;'><b>Total Pending Banner :".$c."</b></font>";
if(!$result)
{
