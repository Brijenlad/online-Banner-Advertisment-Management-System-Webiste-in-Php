...
<div class="wrapper col2">
  <div id="header" class="clear">
    ...
    <div id="topnav">
      <ul>
        <li class="last"><a href="report.php">Report</a><span></span></li>
      
		<li><a href="admin_renew.php">Renew</a></li>	
		 <li><a href="complian_delete.php">Complain</a></li>
		<li><a href="inquiry_delete.php">Inquiry</a></li>
